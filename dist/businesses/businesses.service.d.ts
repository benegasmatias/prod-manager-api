...
export declare class BusinessesService {
    ...
    constructor(businessRepository: Repository<Business>, membershipRepository: Repository<BusinessMembership>, userRepository: Repository<User>, templateRepository: Repository<BusinessTemplate>, orderRepository: Repository<Order>, customerRepository: Repository<Customer>, machineRepository: Repository<Machine>, materialRepository: Repository<Material>, dataSource: DataSource);
